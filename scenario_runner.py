...
from srunner.tools.custom_scenario_parser import CustomScenarioConfigurationParser
...
class ScenarioRunner(object):
    ...
    def _run_scenarios(self):
        ...
        if self.target_dir is not None:
            scenario_configurations = CustomScenarioConfigurationParser(self.target_dir).parse_scenario_configuration(
                self._args.scenario,
...
def main():
    ...
    parser.add_argument('--target-dir', default=None, help='Directory where the scenario files are located')
    ...
    if arguments.list:
        ...
        if arguments.target_dir is not None:
            print(*CustomScenarioConfigurationParser(arguments.target_dir).get_list_of_scenarios(arguments.configFile), sep='\n')
        else:
